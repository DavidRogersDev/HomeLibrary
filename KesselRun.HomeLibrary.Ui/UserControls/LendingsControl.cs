...
namespace KesselRun.HomeLibrary.Ui.UserControls
{
    ...
    public partial class LendingsControl : MvpUserControl, ILendingsView, IHydrateOnFocus
    {
        ...
        private void Lendings_ListChanged(object sender, ListChangedEventArgs e)
        {
            var bla = e;
        }
        ...
        {
            dgvLendings.DataSource = new BindingSource(LendingsViewModel.Lendings, null);
        ...
        private void ReceiveSearchParametersAndGetData(GenericMessage<SearchLendingsViewModel> message)
        {
            ...
            LendingsViewModel.Lendings.ListChanged += Lendings_ListChanged;
        ...
        protected override void OnLoad(System.EventArgs e)
        {
            ...
            PresenterBinder.MessageBus.Register(
                ...
                new Action<GenericMessage<SearchLendingsViewModel>>(ReceiveSearchParametersAndGetData)
                );
            PresenterBinder.MessageBus.Register(
                this,
        ...
        private void dgvLendings_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            var bla = dgvLendings.Rows[e.RowIndex].Cells[e.ColumnIndex];
        }
