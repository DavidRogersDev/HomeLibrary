...
namespace KesselRun.HomeLibrary.EF.Repositories
{
        ...
        where TId : IComparable
    {
        ...
        public PaginatedList<TEntity> Paginate<TKey>(int pageIndex, int pageSize,
        ...
        public PaginatedList<TEntity> PaginateDescending<TKey>(int pageIndex, int pageSize,
            Expression<Func<TEntity, TKey>> keySelector)
        {
        ...
        private PaginatedList<TEntity> Paginate<TKey>(int pageIndex, int pageSize,
            Expression<Func<TEntity, TKey>> keySelector, Expression<Func<TEntity, bool>> predicate,
